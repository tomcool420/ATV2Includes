...
- (void)dealloc;	// 0x33926d25
- (BOOL)perform:(id)perform;	// 0x33926c91
- (void)setKeyValueStore:(id)store;	// 0x33926ced
- (void)setLastModifiedThreshold:(double)threshold;	// 0x33926c7d
@end
